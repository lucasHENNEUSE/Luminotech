...
def scrape_vinsdefrance(nombre_pages=2):
    ...
    for page in range(1, nombre_pages):
        ...
        # recherche les blocs de description
        ...
        for bloc in blocs:
            ...
            for p in paragraphes:
                ...
                for strong in strongs:
                    ...
                    desc_parts = []
                    # On parcourt les éléments jusqu’à rencontrer un <br> ou la fin
                    for sibling in strong.next_siblings:
                        if sibling.name == "br":
                            break
                        # On récupère le texte, même s’il y a des balises à l’intérieur
